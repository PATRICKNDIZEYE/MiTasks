...
contextBridge.exposeInMainWorld('api', {
  ...
  onModeChanged: (cb) => ipcRenderer.on('mode-changed', (_e, mode, offset) => cb(mode, offset)),
  peekOpen: (height) => ipcRenderer.send('peek:open', height),
  peekClose: () => ipcRenderer.send('peek:close'),
